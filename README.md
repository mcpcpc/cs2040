CS2040 is an RP2040-based servo controller project for christmas tree display automation. The CS prefix stands for "Chimney Sweep" as this project was initial designed to articulate 3D figurines that 
